 ...
 * @LastEditors: kevin
 * @LastEditTime: 2022-04-02 17:10:08
 * @Description: 模板设置
-->
<template>
...
<script setup>
  ...
  import { indexTableConfig, indexSearchConfig, removeModelConfig } from './config/dataConfig'
  import { getListPage } from '@/api/target'
  import { updateList } from '@/store'
  import add from './add/addSubTarget.vue'
